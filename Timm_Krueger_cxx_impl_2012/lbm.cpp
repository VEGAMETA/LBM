...
const int t_num = 20000; // number of time steps (running from 1 to t_num)
...
const double particle_center_x = 20; // center position (x-component)
const double particle_center_y = 20; // center position (y-component)
